...
* @version: 1.0.2                                                  *
* @modificado: 24/05/2006 12:51:35 a.m.                            *
*******************************************************************/
...
if (!file_exists(XOOPS_ROOT_PATH."/modules/rmmf/language/".$xoopsConfig['language']."/main.php") ) {
...
$tpl->assign('storedir', rmmf_add_slash(rmmf_web_dir($mc['storedir'])));
