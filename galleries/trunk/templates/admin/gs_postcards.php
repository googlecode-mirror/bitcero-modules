<h1 class="rmc_titles gs_titles"><span style="background-position: -160px;">&nbsp;</span><?php _e('Postcards Management','galleries'); ?></h1>
...
<table class="outer" width="100%" cellspacing="1">
	...
	<tr class="head" align="center">
		...
		<th><?php _e('Title','galleries'); ?></th>
		<th><?php _e('Date','galleries'); ?></th>
		<th><?php _e('Sender','galleries'); ?></th>
		<th><?php _e('View','galleries'); ?></th>
	</tr>
    </thead>
    ...
    <?php if(empty($posts)): ?>
    <tr class="even">
        <td align="center" colspan="6"><?php _e('There are not postcards created yet!','galleries'); ?></td>
    </tr>
    <?php endif; ?>
