...
<table class="outer" cellspacing="0" width="100%">
	...
	<tr class="head" align="center">
		...
		<th align="left"><a href="./sets.php?pag=<?php echo $page; ?>&amp;limit=<?php echo $limit; ?>&amp;search=<?php echo $search; ?>&amp;sort=title&amp;mode=<?php if($sort=='id_set'): ?><?php if($mode==1):?>0<?php else: ?>1<?php endif; ?><?php else: ?>0<?php endif; ?>"><?php _e('Title','galleries'); ?></a></th>
