...
class flickr {
	...
	* Gets the information about a person
	*
	* @param string $username The username who's nsid you want to get
	*
	* @return array $ret_array Contains the nsid of the username passed in
	* @access private
	*/
	function findByUsername($username) {
		...
		// make request to flickr
		$data = $this->makeRequest('flickr.people.findByUsername', array('username'=>$username));
	...
	*
	* @param string $photoset_id The id of the photoset whose info you want to receive
	*
	...
	* @param string $photoset_id The photoset_id whose photos you want to retrieve
	*
