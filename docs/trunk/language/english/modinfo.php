...
define('_MI_RD_URLSMODED',__('This options indicate the way in which RapidDocs will generate the URLs for resources.','docs'));
...
define('_MI_RD_NUMRES', __('Number of resources in the index','docs'));
define('_MI_RD_NUMRESD', __('This is the limit for resources displayed in index','docs'));
define('_MI_RD_CREATENEW', __('Groups with authorization to create new resources','docs'));
define('_MI_RD_CREATENEWD', __('Select the groups that you wish to authorize to create new resources.','docs'));
define('_MI_RD_CREATEENABLED', __('Allow the creation of new resources','docs'));
define('_MI_RD_APPROVE', __('Auto approve resources created for authorized users','docs'));
