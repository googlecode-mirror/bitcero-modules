...
if ($fct!='blocksadmin'){
	$right_widgets = array();
	$right_widgets = RMEvents::get()->run_event('rmcommon.load_right_widgets', $right_widgets);
}
        
// Left Widgets
$left_widgets = RMEvents::get()->run_event('rmcommon.load_left_widgets', $left_widgets);
