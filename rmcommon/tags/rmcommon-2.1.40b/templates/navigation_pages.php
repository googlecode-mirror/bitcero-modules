<div class="rmc_pages_navigation_container">
	...
	<?php if($start>1): ?><span class="page_separators"><img src="<?php echo RMCURL; ?>/images/points.gif" alt="" /></span><?php endif; ?>
	...
	<?php if($start<=$total_pages-$steps): ?><span class="page_separators"><img src="<?php echo RMCURL; ?>/images/points.gif" alt="" /></span><?php endif; ?>
