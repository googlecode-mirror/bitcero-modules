// $Id: forms.js 525 2010-08-27 05:22:05Z i.bitcero $
// --------------------------------------------------------------
// EXM System
...
var usersField = jQuery.extend({
	...
	show_waiting: function(show){
		if (show)
			...
			$("#"+users_field_name+"-dialog-search").html('');
	},
	...
	insert_users: function(multi, uid){
		...
		$("#"+users_field_name+"-dialog-search").html('');
		$("#"+users_field_name+"-dialog-search").dialog('close');
