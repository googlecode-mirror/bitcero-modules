<?php
// $Id: checks.class.php 298 2010-03-15 20:20:53Z i.bitcero $
// --------------------------------------------------------------
	...
	function render(){
		...
		if ($this->asTable){
			...
			foreach ($this->_options as $k => $v){
				...
				$rtn .= "<td><label><input type='checkbox' name='$v[name]' id='$v[name]' value='$v[value]' ";
				//if ($v['state']==1){
	...
	public function render(){
        ...
        if ($this->_type){
            ...
            foreach ($this->_options as $k => $v){
                ...
                $rtn .= "<td><label><input name='".$this->getName()."' id='".$this->getName()."' type='radio' value='$v[value]' ";
		    ...
		    foreach ($this->_options as $k => $v){
			    $rtn .= "<label><input name='".$this->getName()."' id='".$this->getName()."' type='radio' value='$v[value]' ";
			    $rtn .= isset($_REQUEST[$this->getName()]) && $_REQUEST[$this->getName()]==$v['value'] ? "checked='checked' " : ($v['state']==1 ? "checked='checked' " : '');
