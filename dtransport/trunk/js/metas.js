$(document).ready(function(){
    $("#add-meta").click(function(){
        ...
        var html = '<div class="dt_row" id="field-'+$("#meta-name").val()+'"><div class="dt_cell"><input type="text" name="dtMetas['+name+'][name]" value="'+name+'" size="20" />';
        html += '<br /><a href="#" class="del-field" onclick="delete_field($(this)); return false;">'+jsLang.deleteField+'</a></div>';
        html += '<div class="dt_cell"><textarea name="dtMetas['+name+'][value]" rows="3" cols="45">'+$("#meta-value").val()+'</textarea></div></div>';

        $("#the-fields").append(html);
