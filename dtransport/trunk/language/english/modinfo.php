...
//Páginas del módulo
define('_MI_DT_INDEX','Home Page');
define('_MI_DT_CATEGORY','Categories');
define('_MI_DT_PFEATURES','Features');
define('_MI_DT_PFILES','Files');
define('_MI_DT_ITEM','Item Details');
define('_MI_DT_PLOGS','Logs');
define('_MI_DT_MYDOWNS','My Downloads');
define('_MI_DT_PSCREENS','Screenshots');
define('_MI_DT_TAGS','Tags');
define('_MI_DT_SUBMIT','Submit Download');
define('_MI_DT_SEARCH','Search');
define('_MI_DT_DOWNLOAD','Download File');
define('_MI_DT_COMMENTS','Comments');
