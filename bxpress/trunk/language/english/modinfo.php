...
define('_MI_BX_NUMPOST_DESC','Post Maximum Number that will be shown in the post form.');
...
define('_MI_BX_ATTACHLIMIT','Limit for Message Attachments');
define('_MI_BX_ATTACHDIR','Directory to store the attachment');
define('_MI_BX_ATTACHDIR_DESC','This directory must exist in the server and must have view & writing permissions.');
...
define('_MI_BX_STICKYPOSTS','Required number of posts for a user to publish sticky topics');
...
define('_MI_BX_ANNOUNCEMENTSMODE1', 'Recent');
...
define('_MI_BX_NOTNEWTOPICCAPTION_DESC','Sends a notification when a new topic is created in a given forum');
...
define('_MI_BX_NOTNEPOST_CAPTION','Notify when a new message is posted in this topic');
define('_MI_BX_NOTNEPOST_DESC','Send a notification when a new message is posted in a topic');
...
define('_MI_BX_NOTNEPOSTANYFORUM_CAPTION','Notify when a new topic is created in any forum');
define('_MI_BX_NOTNEPOSTANYFORUM_DESC','Send a notification when a new topic is created in any forum');
...
define('_MI_BX_NOTNEPOSTFORUM_CAPTION','Notify when a new topic is added to this forum');
define('_MI_BX_NOTNEPOSTFORUM_DESC','Sent a notification when a new topic is added to this forum');
define('_MI_BX_NOTNEPOSTFORUM_SUBJECT','New topic added');
...
define('_MI_BX_RSSALLDESC','Subscribe to all messages in all forums');
