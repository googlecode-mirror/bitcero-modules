<h1 class="rmc_titles mw_titles"><span style="background-position: -64px -32px;">&nbsp;</span><?php _e('Trackbacks','admin_mywords'); ?></h1>
<div class="descriptions">
    <?php _e('A trackback is one of three types of linkbacks, methods for Web authors to request notification when somebody links to one of their documents.','admin_mywords'); ?>
...
<table class="outer" cellspacing="0">
	...
	<tr align="left">
		...
		<th><?php _e('Title','admin_mywords'); ?></th>
	...
	<tr class="even error" align="center">
		<td colspan="6"><?php _e('There are not trackbacks yet','admin_mywords'); ?></td>
	</tr>
	<?php endif; ?>
	...
	<tr class="<?php echo tpl_cycle("even,odd"); ?>" valign="top">
		...
		<td align="center"><?php if($post['title']==''): ?><?php _e('Unknow','admin_mywords'); ?><?php else: ?><a href="<?php echo $post['link']; ?>"><?php echo $post['title']; ?></a><?php endif; ?></td>
	</tr>
	<?php endforeach; ?>
	</tbody>
</table>
